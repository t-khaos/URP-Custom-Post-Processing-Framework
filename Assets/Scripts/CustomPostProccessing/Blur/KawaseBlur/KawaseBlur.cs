...
namespace CPP.EFFECTS{
    [VolumeComponentMenu("Custom Post Processing/Blur/Kawase Blur")]
    public class KawaseBlur : CustomPostProcessing{
        ...
        private const string mShaderName = "Hidden/PostProcessing/KawaseBlur";
